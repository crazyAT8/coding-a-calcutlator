...
let haveDot = false;
                                ...
                                /*=====================================
                                        Decimal Point or the Dot(.)
                                =======================================*/

numbersE1.forEach( number => {
    number.addEventListener('click', (e)=> {
        if(e.target.innerText === '.' && !haveDot){                        //this makes sure that the dot can only be applied once
            haveDot = true;
        }else if(e.target.innerText === '.' && haveDot){
            return;
        }
        dis2Num += e.target.innerText;                                      //text concatination
...
clearLastE1.addEventListener('click', (e) => {
    ...
    dis2Num = '';
            ...
            /*==================================================================================================
            Link your keyboard to work with the calculator, so don't always have to click the on screen buttons
            ====================================================================================================*/
